...
# Place the Server and Client scripts along with this script in the same folder.
# The doulbe set of quotes indicates the path is local to the script.
authenticationCertSubFolder=""
...
# script's output as the Client cert keystore password:)
...
passwordForTheNewIdentityFile="password"
